...
{
    /// <inheritdoc />
    public partial class PaymentFlowModule_AddColumns : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // NOTE:
            // Migration này ban đầu được sinh ra theo hướng "tạo lại toàn bộ" (CreateTable cho nhiều bảng).
            // Database của bạn đã có schema từ migration InitDB, nên chạy phần đó sẽ gây lỗi.
            // Vì vậy, ta chỉ bổ sung các cột cần thiết cho module Payment và thoát khỏi method.
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultCompensationPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomAssetId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemporaryGuests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualDeposit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomAssets_AssetCategories_AssetCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldElectricity = table.Column<double>(type: "float", nullable: false),
                    NewElectricity = table.Column<double>(type: "float", nullable: false),
                    OldWater = table.Column<double>(type: "float", nullable: false),
                    NewWater = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderOrderCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    QrContent = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CheckoutUrl = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExpiredAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CustomerMarkedPaidAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomAssets_AssetCategoryId",
                table: "RoomAssets",
        ...
        {
            // Revert only Payment-related columns.
